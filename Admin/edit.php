...
<tr>
<td>Start Date</td><td><input name="sdate" type="text" class="textbox" id="dpxyz" value="<?php echo $row['dresource_startdate']; ?>" ></td>
</tr>
<tr></tr><tr></tr>
<tr>
<td>End Date</td><td><input name="edate" type="text" class="textbox" id="dpxyz1" value="<?php echo $row['dresource_enddate']; ?>" ></td>
</tr>
...
$date = $_POST['sdate'];
	...
	$q=mysqli_query($con,"update tbl_resource_allocation set vchdesignation_id='$_POST[design]',fper_allocation_req='$_POST[per_allocation]',fbillability_per='$_POST[bill]',dresource_startdate='$start_date',dresource_enddate='$end_date' where Srno='$_SESSION[srnoid]' ");
        if($q)
        {
