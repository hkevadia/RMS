...
if(isset($_POST['submit']))
{
	...
	{	
		...
		$sql = "select * from tbl_user where vchemp_id='$_SESSION[userid]' AND vchpswd='$_POST[oldpass]' ";
		...
		{ 
			...
			{
				$sql1 = "update tbl_user set vchpswd='$_POST[newpass]' where vchemp_id='$_SESSION[userid]' ";
				...
				{
					echo "<center class=error>Password is not Updated</center>";
				}
			}
			else
			{
