...
<td>
<?php 
$query=mysqli_query($con,"select * from tbl_sow where bproj_status!='0' AND vchph='$_SESSION[adminid]' order by vchproject_name");
...
<tr></tr><tr></tr>
<tr>
<td>Billability Percentage</td><td><input type="text" maxlength="5" class="textbox" name="bill_per" value="<?php if(isset($_POST['bill_per'])) { echo $_POST['bill_per']; } ?>"><span class="error"> * <?php echo $bill_per_Err;?></span></td>
</tr>
<tr></tr><tr></tr>
<tr>
<td>Percentage Allocation Required</td><td><input type="text" maxlength="5" class="textbox" name="per_allocation" value="<?php if(isset($_POST['per_allocation'])) { echo $_POST['per_allocation']; } ?>"><span class="error"> * <?php echo $per_allocation_Err;?></span></td>
</tr>
<tr></tr><tr></tr>
<tr>
