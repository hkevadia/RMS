...
<td>
<?php 
$query=mysqli_query($con,"SELECT vchproject_id, vchproject_name FROM  tbl_sow WHERE vchph='$_SESSION[userid]' or vchdept_id=(select vchdept_id from tbl_practicehead where vchemp_id='$_SESSION[userid]') order by vchproject_name ");
...
echo "<form method='post' onsubmit=ShowLoading()>";
	...
	{ 
		...
		while($row=mysqli_fetch_array($qry))
		{
			...
			echo "<td><a href='edit1.php?srid=$row[Srno]'><img src='../icons/sub1.ico' title='Submit' class='ig'>&nbsp;&nbsp;</a><a href='sowsaved.php?srno=$row[Srno]'><img src='../icons/sub1.ico' title='Submit' class='ig'>&nbsp;&nbsp;</a><a href='sowsaved.php?srno1=$row[Srno]'><img src='../icons/remove.png' class='ig' title='Delete'></a></td>";
		}
	}
	else
	{
