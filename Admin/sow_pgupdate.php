...
<td>
<select name="updateproj_id"  class="textbox">
  <?php 
...
<?php
	$aqry=mysqli_query($con,"select vchemp_id,vchemp_Fname,vchemp_Lname from tbl_emp where vchdesignation_id=(select vchdesignation_id from tbl_designation where vchdesignation_name='Acc_manager')");
	if($aqry)
	{
		echo "<select name='selacc' class='textbox'>";
...
<?php
	$qry= mysqli_query($con,"select * from tbl_billing");
...
<select name="selstatus" class="textbox">
	<?php 
		$selsta=mysqli_query($con,"select * from tbl_sowstatus");
...
$date = $_POST['startdate'];
	...
	$sowqry=mysqli_query($con,"update tbl_sow set vchproject_name='$_POST[proj_name]', vchclient_name='$_POST[clnt_name]', dsow_startDate='$start_date', dsow_endDate='$end_date', vchacc_manager='$_POST[selacc]', vchbilling_type='$_POST[billingtype]', istatus_id='$_POST[selstatus]', vchdescription='$_POST[desc]' where vchproject_id='$_GET[sowid]'");
