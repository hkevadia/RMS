...
<h2>SOW Resource Requirement</h2>
   <select name="selpid" class="textbox">
    ...
    <?php
        $pqry=mysqli_query($con,"select * from tbl_sow where vchph='$_SESSION[userid]' or vchdept_id=(select vchdept_id from tbl_practicehead where vchemp_id='$_SESSION[userid]') order by vchproject_name");
