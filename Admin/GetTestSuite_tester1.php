...
if ($result = $con->query($qry)) {
	...
	{
		?>
		<option value="<?php echo $row1['vchSdept_id']; ?>" <?php if($_SESSION['sdept12']==$row1['vchSdept_id']){echo "selected";} ?> > <?php echo $row1['vchSdept_name']; ?> </option>
		<?php
    }
    ...
    header('Refresh: 0;url=resupdt.php');
}
?>