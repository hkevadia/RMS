...
<td>
<?php 
$res=mysqli_query($con,"select * from tbl_emp where vchemp_id='$_SESSION[userid]' ");
$rres=mysqli_fetch_array($res);

$query=mysqli_query($con,"select distinct tbl_resource_allocation.vchproject_id,vchproject_name,vchph,vchdept_id from tbl_resource_allocation,tbl_sow where tbl_sow.vchproject_id=tbl_resource_allocation.vchproject_id AND vchdept_id='$rres[vchdept_id]' AND bsaved_status='-1' and bproj_status!='0'  order by vchproject_name");
...
?>
<?php
if(isset($_POST['btnall']) && $_POST['selres']!='')
{
		//echo $_POST['selres'];
...
echo "<form method='post'>";
	...
	{ 
		...
		echo "<thead><tr><th>Skills</th><th>Designation</th><th>Start date</th><th>End Date</th><th>Allocation Required</th><th>Request Type</th><th>Actions</th></tr></thead>
                <tbody>";
...
$_SESSION['srno1']=$_GET['srno'];
	...
	{
		//$status1=0;
		echo "<br><br><br><table class='t3' border='0' cellpadding='0' cellspacing='0'><h2>As Per Request</h2><thead><tr><th>Employee Id</th><th>Name</th><th>Designation</th><th>Total Allocation</th><th style='padding-right:54px;'>Action</th></tr></thead><tbody>";
...
echo "</form>";
	...
	{ 
		echo "<script type='text/javascript'>";
		echo "alert('No such employee exists....')";
		echo "</script>";
		echo "<script>window.location.href='res_allocation.php';</script>";
	}*/
	
echo "<br><form method='POST'><input type='submit' value='Back' name='back1' class='button'></form>";
