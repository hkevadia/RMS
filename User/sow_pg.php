...
$proj_idErr = $proj_nameErr = $etypeErr = $proj_mngrErr = $clnt_nameErr = $billingtypeErr = $startdateErr = $enddateErr = $acc_mngrErr = $descErr = $selstatusErr = "";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") 
{
	...
	{
		$status=1;
		$selstatusErr = "Select SOW status";
	}
	if (empty($_POST["txtdeptnm"]))
	{
		$status=1;
		$selstatusErr1 = "Select Department";
	}
if (empty($_POST["selbloc"]))
	{
		$status=1;
		$selstatusErr2 = "Select Billing location";
	}
...
<tr></tr><tr></tr>
<tr>
<td>Project Name</td><td><input name="proj_name" type="text"  class="textbox" value="<?php if(isset($_POST['proj_name'])) { echo $_POST['proj_name']; } ?>" placeholder="Project Name"> <span class="error"> * <?php echo $proj_nameErr;?></span> </td>
</tr>
<tr></tr><tr></tr>
<tr>
<td>Customer Name</td><td><input name="clnt_name"  class="textbox" type="text" value="<?php if(isset($_POST['clnt_name'])) { echo $_POST['clnt_name']; } ?>" placeholder="Client name"> <span class="error"> * <?php echo $clnt_nameErr;?></span> </td>
</tr>
<tr></tr><tr></tr>
<tr>
...
<td>SOW End date</td>
<td>
<!--<input name="enddate" type="text" class="textbox" id="dpxyz" value="<?php //if(isset($_POST['enddate'])) { echo $_POST['enddate']; } ?>" id="enddate">-->
...
<td><select name="billingtype"  class="textbox">
	<?php echo "<option value=''>Select Value</option>"; ?>
<?php
...
<span class="error">* <?php echo $selstatusErr;?></span> </td>
</td>
</tr>
<tr></tr><tr></tr>
<tr>
...
<!--<select name="seldept" class="textbox">
	<option value="">Select Value</option>-->
	<?php 
		$selsta=mysqli_query($con,"select * from tbl_dept where vchdept_id=(select vchdept_id from tbl_practicehead where vchemp_id='$_SESSION[userid]') order by vchdept_name");
		while($rst=mysqli_fetch_array($selsta))
		{
			?>
...
<input type="text" value="<?php echo $rst['vchdept_name']; ?>" readonly name="txtdeptnm" class="textbox">
<?php $_SESSION['deptid']=$rst['vchdept_id'];?>
			<?php
		}

	?>
</select>
<span class="error"> <?php echo $selstatusErr1 ;?></span> </td>
</td>
</tr>
<tr></tr><tr></tr>
<tr>
...
<span class="error">* <?php echo $selstatusErr2;?></span> </td>
</td>
</tr>
<tr></tr><tr></tr>
<tr>
<td>Description</td><td><textarea  class="textbox" name="desc" rows="4" cols="25"><?php if(isset($_POST['desc'])) { echo $_POST['desc']; } ?></textarea></td>
</tr>

<tr></tr><tr></tr><tr></tr><tr></tr>
<tr>
<td align="center"><input name="btnsub" type="submit" value="Create" class="patiya"></td>
